...
var createComponent = function () { return __awaiter(_this, void 0, void 0, function () {
    var answer, COMPONENT_NAME, COMPONENT_TEST;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, inquirer.prompt(questions_1.default)];
            case 1:
                answer = _a.sent();
                COMPONENT_NAME = answer.COMPONENT_NAME, COMPONENT_TEST = answer.COMPONENT_TEST;
                doCreateComponent(COMPONENT_NAME, COMPONENT_TEST);
                return [2 /*return*/];
        }
    });
}); };
function helper(pureFilename, ext, pathInFilename, result, cb) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            try {
                fs.writeFile(constants_1.DEFAULT_PATH + "/" + pathInFilename + "/" + pureFilename + "/" + pureFilename + "." + ext, result, function (err) {
                    if (err) {
...
var doCreateComponent = function (filename, isTestIncluded) { return __awaiter(_this, void 0, void 0, function () {
    var templatePath, templateTestPath, splitFilename, pureFilename, pathInFilename, result, err_1, result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                result = _a.sent();
                return [4 /*yield*/, helper(pureFilename, 'tsx', pathInFilename, result, function () {
            ...
            case 5:
                ...
                return [3 /*break*/, 6];
            case 6:
                if (!isTestIncluded) return [3 /*break*/, 11];
                _a.label = 7;
            case 7:
            ...
            case 8:
                result = _a.sent();
                return [4 /*yield*/, helper(pureFilename, "test.tsx", pathInFilename, result, function () {
