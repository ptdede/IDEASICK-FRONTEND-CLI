    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                switch (ACTIONS) {
                    case constants_1.COMPONENT:
                        createComponent_1.default();
                        break;
                    case constants_1.CONTAINER:
                        console.log("YOU'RE ABOUT TO CREATE CONTAINER!");
                        break;
                    case constants_1.SAY_HI:
                        console.log(chalk_1.default.green("Well, Hello! :)"));
                        break;
                    default:
                        console.log(chalk_1.default.red("Bye!"));
                        break;
                }
                return [2 /*return*/];
        }
